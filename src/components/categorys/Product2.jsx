        ...
        <div className="mx-auto flex h-full w-full max-w-screen-lg flex-col justify-center p-4 ">
          ...
          <div className="grid gap-8 md:px-12 grid-cols-1 sm:grid-cols-2  lg:grid-cols-2">
            {portfolios.map(({ id, src, code, category, brand }) => (
              <div
                key={id}
                className="rounded-lg shadow-lg shadow-[#fd0101] duration-200 hover:scale-105"
              >
            ...
            <div className="rounded-lg shadow-lg shadow-[#fd0101] duration-200 hover:scale-105">
